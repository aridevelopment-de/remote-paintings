    ...
    public static LiteralArgumentBuilder<FabricClientCommandSource> register() {
        return ClientCommandManager.literal("paintingInfo")
                    .executes(ctx -> {
                        ...
                        ctx.getSource().sendFeedback(Text.of("Painting Info:").getWithStyle(Style.EMPTY.withColor(Formatting.YELLOW)).getFirst());
                        ...
                        ctx.getSource().sendFeedback(variant.author().orElse(Text.of("Kein Autor gegeben")).getWithStyle(Style.EMPTY.withColor(Formatting.GREEN)).getFirst());
                        ctx.getSource().sendFeedback(variant.title().orElse(Text.of("Kein Titel gegeben")).getWithStyle(Style.EMPTY.withColor(Formatting.GREEN)).getFirst());
                        ...
                        ctx.getSource().sendFeedback(Text.of("Remote Painting Info:").getWithStyle(Style.EMPTY.withColor(Formatting.YELLOW)).getFirst());
